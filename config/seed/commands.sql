...
INSERT INTO `workflows` (workflow_id, trigger_id) VALUES 
('wf-test','test_test'),
('wf-jam','jam_jam');

INSERT INTO `wf_steps` (wf_id, step_id, action, message) VALUES 
...
INSERT INTO `wf_branches` (step_id, action_id, next_step_id, text) VALUES 
...
INSERT INTO `wf_options` (step_id, name, value) VALUES 
